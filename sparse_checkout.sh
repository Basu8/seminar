...
git_folder_location='/Users/anisdas/Documents/hardl'   #replace with the local root folder location where you want to create the project folder
project_name=Seminar   #replace with your project name
github_org_name=code50   #replace with your github org name
project_template_github_url=https://github.com/code50/hardml    #replace with the url for the project template for your organization created in step 2.2, or leave for demo purposes
